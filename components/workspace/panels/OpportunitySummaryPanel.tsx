      ...
      <div className="p-4 sm:p-6">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="p-5 bg-white border border-stone-200 rounded-lg">
            ...
            ) : opportunity.rawData?.source === 'subnet' ? (
              <div className="py-4 text-center">
                <p className="text-sm text-stone-500 mb-1">SubNet listings don't carry file attachments</p>
                <p className="text-xs text-stone-400 mb-3">
                  SBA's directory posts the scope in the description only.
                  Reach out to the prime for their bid package.
                </p>
                {samGovUrl && (
                  <a
                    href={samGovUrl}
